...
export const addUserService = async (id, serviceId, price, isActive) => {
    const { data } = await API.post(`/user/appointments/${id}`,
        {
...
export const updateUserService = async (id, serviceId, price, isActive) => {
    const { data } = await API.patch(`/user/appointments/${id}/${serviceId}`,
        {
            is_active: isActive,
            price,
        },
...
export const deleteUserService = async (id, serviceId, price, isActive) => {
    const { data } = await API.patch(`/user/appointments/${id}/${serviceId}`,
        { withCredentials: true }
    );
    return data.data;
