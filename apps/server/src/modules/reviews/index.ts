...
export const reviewsController = new Elysia({ prefix: "/reviews" })
    ...
    .post(
        "/me",
        async ({ body, user }) => ReviewsService.publishMe(body, user.uid),
        {
    ...
    .get(
        ...
        async ({ params }) => ReviewsService.getByProvider(params.provider_id),
        {
    ...
    .get(
        "/client/:client_id",
        async ({ params }) => ReviewsService.getByClientId(params),
        {
    ...
    .get(
        ...
        async ({ params }) => ReviewsService.getByAppointmentId(params),
        {
