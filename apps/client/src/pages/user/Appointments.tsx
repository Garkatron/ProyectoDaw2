...
import { CheckCircle, Clock, Banknote, RefreshCw, Star } from "lucide-react";
import {
    Badge, Box, Center, Group, Loader, Modal, Paper, Rating,
    ScrollArea, SimpleGrid, Stack, Text, Title, Button,
} from "@mantine/core";
        ...
        <Paper withBorder p="md" shadow="xs" radius="md">
            ...
            <Stack gap={8}>
                ...
                <Group justify="space-between">
                    ...
                    {/* Fix: italic is a style, not a color value */}
...
export default function Appointments() {
    ...
    if (loading)
        return (
            <Base>
                <Center h="80vh">
                    {/* Fix: Loader was used but never imported */}
                    <Loader />
                </Center>
            </Base>
        );
